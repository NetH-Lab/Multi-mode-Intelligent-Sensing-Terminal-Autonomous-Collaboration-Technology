HAL_DRIVER_SRC =  \
        ...
        $(SDK_DIR)/drivers/third_party/GigaDevice/GD32VF103_standard_peripheral/Source/gd32vf103_pcram.c    \
...
USER_SRC =  \
        ...
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/usart.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/liteos_all_tasks.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/wificommand.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/router.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/wifitask.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/timer.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/i2c.c \
        $(SDK_DIR)/targets/GD32VF103V_EVAL/Src/sht30.c \
